...
chunk_dir = "output_chunk-images13"
caption_dir = "output_captions13"
...
if __name__ == "__main__":
    ...
    for order in tqdm(range(n_data), desc="Processing images"):
        ...
        for idx in range(num_images):
            ...
            ## save files
            cv2.imwrite(f"{chunk_dir}/3_{filename}_{idx}.jpg", chunk)
            with open(f"{caption_dir}/3_{filename}_{idx}.txt", "w") as f:
                f.write(caption)
