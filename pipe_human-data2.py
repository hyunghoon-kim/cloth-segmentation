...
chunk_dir = "output_chunk-images12"
caption_dir = "output_captions12"
...
if __name__ == "__main__":
    ...
    for order in tqdm(range(n_data), desc="Processing images"):
        ...
        for idx in range(num_images):
            ...
            ## save files
            cv2.imwrite(f"{chunk_dir}/2_{filename}_{idx}.jpg", chunk)
            with open(f"{caption_dir}/2_{filename}_{idx}.txt", "w") as f:
                f.write(caption)
