...
# 10_000 is 2500
n_data = 1000 // 4 # *4 data gen 

url = "http://127.0.0.1:8197"
device = "cuda:7"
...
chunk_dir = "output_chunk-images17"
caption_dir = "output_captions17"
...
if __name__ == "__main__":
    ...
    for order in tqdm(range(n_data), desc="Processing images"):
        ## make dirs
        ...
        for idx in range(num_images):
            ...
            ## save files
            cv2.imwrite(f"{chunk_dir}/7_{filename}_{idx}.jpg", chunk)
            with open(f"{caption_dir}/7_{filename}_{idx}.txt", "w") as f:
                f.write(caption)
